#!/bin/bash
set -e
yum install -y sed git centos-release wget make autoconf libtool automake rpm-build gcc gcc-c++ zlib-devel glib2-devel libpcap-devel c-ares-devel flex bison
